...
const WORDS = ["Software Engineer", "Fullstack Developer" , "Cyber Security" , "UX/UI Designer"];
const TECH_STACK = ["HTML", "CSS", "Javascript", "Tailwind", "Java", "Python", "C#", "PHP", "Typescript", "React", "Node.js", "ASP.NET", "Flutter","MongoDB", "MySQL"];
const SOCIAL_LINKS = [
  { icon: Linkedin, link: "https://www.linkedin.com/in/chhinchheang-dara/" },
  { icon: Instagram, link: "https://www.instagram.com/chhinchheangdara?igsh=MWdjdW0zcGR0azBrYw%3D%3D&utm_source=qr" },
  { icon: Github, link: "https://github.com/darathegod" },
  { icon: Facebook, link: "https://github.com/darathegod" },
  ...
  //   </svg>
  //   ), 
  //   link: "https://www.tiktok.com/@evelyn_adelaide?_t=ZS-8uB8IMrjfRo&_r=1" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  I create innovative, intuitive, and high-performance websites designed for seamless digital solutions. Elevate your online presence with a user-friendly experience that drives results.
                </p>
                {/* Tech Stack */}
