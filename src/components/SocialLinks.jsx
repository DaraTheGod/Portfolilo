...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/chhinchheang-dara/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@chhinchheang dara",
    icon: Instagram,
    url: "https://www.instagram.com/chhinchheangdara?igsh=MWdjdW0zcGR0azBrYw%3D%3D&utm_source=qr",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@darathegod",
    icon: Github,
    url: "https://github.com/darathegod",
    color: "#ffffff",
  ...
  },
  {
    ...
    subText: "@chhinchheang dara",
    icon: Facebook,
    url: "https://www.facebook.com/share/163xsWc1tw/?mibextid=wwXIfr",
    color: "#0A66C2",
    gradient: "from-[#0A66C2] to-[#0077B5]",
  },
    // {
  ...
  // },
  {
    ...
    url: "https://www.tiktok.com/@evelyn_adelaide?_t=ZS-8uB8IMrjfRo&_r=1",
    color: "black",
